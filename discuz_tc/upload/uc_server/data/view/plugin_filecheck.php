...
<?php if($deletedfiles > 0) { ?>
	<a href="###" onclick="showresult('del')"><em class="edited">被刪除: <?php echo $deletedfiles;?></em></a>&nbsp;&nbsp;
<?php } ?>
<?php if($unknownfiles > 0) { ?>
	<a href="###" onclick="showresult('add')"><em class="edited">未知: <?php echo $unknownfiles;?></em></a>&nbsp;&nbsp;
<?php } ?>
<?php if($doubt > 0) { ?>
	<a href="###" onclick="showresult('doubt')"><em class="edited">一周內被修改: <?php echo $doubt;?></em></a>&nbsp;&nbsp;
<?php } ?>
