...
0
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/home/space_prompt_nav.htm', 1387491967, 'diy', './data/template/1_diy_home_space_notice.tpl.php', './template/default', 'home/space_notice')
;?>
...
<ul class="tb cl">
<li class="y"><a href="home.php?mod=spacecp&amp;ac=privacy&amp;op=filter" target="_blank" class="xi2">篩選設置</a></li>
...
<div class="ct_vw_sd">
<ul class="mtw">
<?php if($list) { ?><li><a href="home.php?mod=space&amp;do=notice&amp;view=userapp">全部應用消息</a></li><?php } if(is_array($apparr)) foreach($apparr as $type => $val) { ?><li class="mtn">
...
<a href="home.php?mod=space&amp;do=notice&amp;view=userapp&amp;type=<?php echo $val['0']['appid'];?>"> <?php echo count($val);?> 個 <?php echo $val['0']['typename'];?> <?php if($val['0']['type']) { ?>請求<?php } else { ?>邀請<?php } ?></a>
</li>
<?php } ?>
</ul>
</div>
...
<a href="home.php?mod=space&amp;do=notice&amp;view=userapp&amp;op=del&amp;appid=<?php echo $invite['0']['appid'];?>" class="y xg1">忽略該應用的所有邀請</a>
...
您有 <?php echo count($invite);?> 個 <?php echo $invite['0']['typename'];?> <?php if($invite['0']['type']) { ?>請求<?php } else { ?>邀請<?php } ?>
</h4>
...
<?php if($new == 1) { ?>
暫時沒有新提醒，<a href="home.php?mod=space&amp;do=notice&amp;isread=1">點此查看已讀提醒</a>
<?php } else { ?>
暫時沒有提醒內容
<?php } ?>
</div>
...
<dd class="xg1 xw0">還有 <?php echo $value['from_num'];?> 個相同通知被忽略</dd>
<?php } ?>
...
<div class="mtm mbm"><a href="home.php?mod=space&amp;do=notice&amp;ignore=all">還有 <?php echo $value['from_num'];?> 個相同通知被忽略 <em>&rsaquo;</em></a></div>
...
<li<?php echo $actives['userapp'];?>><em class="notice_userapp"></em><a href="home.php?mod=space&amp;do=notice&amp;view=userapp">應用消息<?php if($mynotice) { ?>(<?php echo $mynotice;?>)<?php } ?></a></li>
<?php } ?>
</ul>
</div><div class="drag">
