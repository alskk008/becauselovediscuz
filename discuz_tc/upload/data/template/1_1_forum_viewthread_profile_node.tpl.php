...
?><?php
$return = <<<EOF
<div id="g_up{$post['pid']}_menu" class="tip tip_4" style="display: none;"><div class="tip_horn"></div><div class="tip_c">{$post['authortitle']}, 積分 {$post['credits']}, 距離下一級還需 {$post['upgradecredit']} 積分</div></div>
EOF;
?><?php 
return $return;
}
